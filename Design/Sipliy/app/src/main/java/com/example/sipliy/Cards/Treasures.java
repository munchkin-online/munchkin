...
public class Treasures //класс карт сокровищ (общая колода с картами сокровищ)
{
    ...
    public void fill()
    {
        ...
        items.add(new Items(11020, "Лучок С Ленточками",4,  5, 3, 1, 1, 800,
        ...
        items.add(new Items(11029, "Рапира Такнечестности",3,  4, 3, 1, 1, 600,
                R.drawable.d31029,R.drawable.d11029));
        items.add(new Items(11030, "Швейцарская Армейская Алебарда",4,  5, 5, 1, 1, 600,
